...
#define DN_DATA_LEN   27         // 下行帧数据段固定长度（单位：字节）
 ...
 * @note   所有角度/高度单位均为0.1倍实际值（如角度1800=180.0°，高度200=20.0mm）
 */
typedef struct {
    int16_t  pc_target_angles[12]; // 12路电机/舵机目标角度（单位：0.1°，数组索引0~11对应不同电机）
